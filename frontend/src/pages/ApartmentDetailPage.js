...
export default function ApartmentDetailPage() {
  ...
  useEffect(() => {
    const apt = apartmentsData.find(apt => apt.id === parseInt(id));
    setApartment(apt);
  }, [id]);
  ...
  return (
    <div className="min-h-screen bg-neutral-light">
      ...
      {/* Header */}
      <section className="pt-24 pb-8 luxury-gradient">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8 mb-8 sticky top-24">
              ...
              <div className="space-y-4 mb-8">
                <button className="w-full bg-accent hover:bg-accent-600 text-white px-6 py-4 rounded-lg font-semibold text-lg transition-colors">
                  Оставить заявку
                </button>
                
                <button className="w-full border-2 border-accent text-accent hover:bg-accent hover:text-white px-6 py-4 rounded-lg font-semibold text-lg transition-colors">
                  Забронировать
                </button>
              </div>
