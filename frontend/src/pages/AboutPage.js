...
import { ContinuousSec } from "../components/ContinuousSec/ContinuousSec";
export default function AboutPage() {
  //   const teamMembers = [
  //     {
  //       name: 'Ильяс Муталиев',
  //       position: 'Директор',
  //       image: 'https://storage.yandexcloud.net/vizuz/ilez.jpg',
  ...
  //                 Компания Grand Komfort Stroy была основана в 2020 году с одной простой, но амбициозной целью — создавать жильё премиум-класса, которое станет настоящим домом для наших клиентов.
  //               </p>
  //               <p className="text-lg text-gray-700 mb-6 leading-relaxed">
  ...
  //                 Сегодня Grand Komfort Stroy — это команда профессионалов, объединённых общей идеей создания качественного и комфортного жилья для людей, которые ценят качество жизни.
  //               </p>
  //             </div>

  //            <div className="animate-slide-in-right lg:flex lg:justify-end">
  //           {/* Контейнер по ширине половины экрана и фиксированной высотой */}
  //          <div className="w-full lg:w-5/6 h-48 md:h-[600px] overflow-hidden">
  //   <img
  //     src="https://storage.yandexcloud.net/vizuz/photo_5458689076149483018_y.jpg"
  ...
  //               <div
  //                 key={index}
  //                 className="text-center p-6  bg-gray-50 hover:bg-accent/5 transition-colors animate-slide-up"
  ...
  //             </h2>
  //             <p className="text-xl text-gray-600 max-w-3xl mx-auto">
  //               Путь развития компании Grand Komfort Stroy
  //             </p>
  //           </div>
  ...
  //               <div
  //                 key={index}
  //                 className="flex flex-col md:flex-row items-center bg-white  p-8 hover-lift animate-slide-up"
  ...
  //               <div
  //                 key={index}
  //                 className="text-center bg-gray-50 p-8 hover-lift animate-slide-up"
  //                 style={{ animationDelay: `${index * 0.2}s` }}
  //               >
