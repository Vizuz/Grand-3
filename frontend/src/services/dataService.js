...
class DataService {
  ...
  resetToDefaults() {
    const initialProjects = [
      ...
      //   status: "Сдан в 2023",
      //   image:
      //     "https://images.unsplash.com/photo-1519662978799-2f05096d3636?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwxfHxtb2Rlcm4lMjBhcmNoaXRlY3R1cmV8ZW58MHx8fHwxNzQ4MDE1MTk5fDA&ixlib=rb-4.1.0&q=85",
      ...
      //   image:
      //     "https://images.unsplash.com/photo-1574848296471-28f79a036f79?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwzfHxtb2Rlcm4lMjBhcmNoaXRlY3R1cmV8ZW58MHx8fHwxNzQ4MDE1MTk5fDA&ixlib=rb-4.1.0&q=85",
      ...
      // },
      {
        ...
        status: "Сдан в 2022",
        image:
          "https://images.unsplash.com/photo-1546349851-64285be8e9fa?crop=entropy&cs=srgb&fm=jpg&ixid=M3w3NDk1ODB8MHwxfHNlYXJjaHwyfHxtb2Rlcm4lMjBhcmNoaXRlY3R1cmV8ZW58MHx8fHwxNzQ4MDE1MTk5fDA&ixlib=rb-4.1.0&q=85",
    ...
    const initialApartments = [
      ...
      },
      {
        ...
        description:
          "Современная студия с оптимальным использованием пространства",
        available: true,
      },
      {
        id: 4,
        ...
        description:
          "Угловая двухкомнатная квартира с дополнительным освещением",
        available: true,
      },
      {
        id: 5,
  ...
  addApartment(apartment) {
    ...
    const project = projects.find(
      (p) => p.id === parseInt(apartment.projectId),
    );
  ...
  updateApartment(id, apartmentData) {
    ...
    const projects = this.getProjects();
    const project = projects.find(
      (p) => p.id === parseInt(apartmentData.projectId),
    );
  ...
  getAdminStats() {
    ...
    return {
      ...
      conversionRate:
        analytics.leads > 0
          ? ((analytics.conversions / analytics.leads) * 100).toFixed(1)
          : "0.0",
    };
  }
