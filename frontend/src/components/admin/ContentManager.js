  ...
  return (
    <div className="space-y-6">
            ...
            {teamMembers.map((member) => (
              <div key={member.id} className="bg-white rounded-lg shadow-lg p-6">
                <div className="text-center">
                  ...
                  />
                  <h4 className="text-lg  text-primary-900 mb-1">{member.name}</h4>
      ...
      {activeSection === 'faq' && (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h3 className="text-xl  text-primary-900">Часто задаваемые вопросы</h3>
            <button
              ...
              <div key={item.id} className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h4 className="text-lg  text-primary-900 mb-2">{item.question}</h4>
