...
export default function ContentManager() {
  ...
  const [companyInfo, setCompanyInfo] = useState({
    ...
    description:
      "Уже более 15 лет мы создаём элитную недвижимость, объединяя традиции качественного строительства с современными технологиями",
    story:
      "Компания GRAND была основана в 2008 году с одной простой, но амбициозной целью — создавать жильё премиум-класса, которое станет настоящим домом для наших клиентов.",
    mission:
  ...
  const [teamMembers, setTeamMembers] = useState([
    {
      ...
      image:
        "https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?crop=face&w=300&h=300",
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/1181686/pexels-photo-1181686.jpeg?crop=face&w=300&h=300",
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/2182970/pexels-photo-2182970.jpeg?crop=face&w=300&h=300",
          ...
          <form onSubmit={handleCompanySubmit} className="space-y-6">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCompanyInfo({ ...companyInfo, story: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2"
                rows="5"
              />
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  setCompanyInfo({ ...companyInfo, mission: e.target.value })
                }
                className="w-full border border-gray-300 rounded-lg px-3 py-2"
                rows="2"
              />
      ...
      {activeSection === "team" && (
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <h3 className="text-xl  text-primary-900">Команда</h3>
            <button
            ...
            {teamMembers.map((member) => (
              ...
              >
                <div className="text-center">
                  ...
                  />
                  <h4 className="text-lg  text-primary-900 mb-1">
                    {member.name}
                  </h4>
                ...
                <form onSubmit={handleTeamSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setTeamForm({ ...teamForm, experience: e.target.value })
                      }
                      className="w-full border border-gray-300 rounded-lg px-3 py-2"
              ...
              <div key={item.id} className="bg-white rounded-lg shadow-lg p-6">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h4 className="text-lg  text-primary-900 mb-2">
                      {item.question}
                    </h4>
