  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg  text-primary-900 mb-4 flex items-center">
            ...
            {weeklyData.map((day, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <div className="text-right">
                  <div className="text-sm  text-primary-900">{day.visitors}</div>
        ...
        {/* Источники трафика */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg  text-primary-900 mb-4">Источники трафика</h3>
          ...
          <div className="space-y-4">
            {trafficSources.map((source, index) => (
              <div key={index} className="flex items-center justify-between">
                ...
                <span className="ml-4 text-sm  text-primary-900">{source.percentage}%</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {/* Популярные страницы */}
        <div className="bg-white rounded-lg shadow-lg p-6">
          <h3 className="text-lg  text-primary-900 mb-4">Популярные страницы</h3>
          ...
          <div className="space-y-3">
            {topPages.map((page, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <span className="text-sm  text-accent">{page.percentage}%</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="space-y-3">
            {popularApartments.map((apartment, index) => (
              <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                ...
                <div className="text-right">
                  <div className="text-sm  text-primary-900">{apartment.views}</div>
      ...
      <div className="bg-white rounded-lg shadow-lg p-6">
        <h3 className="text-lg  text-primary-900 mb-4">Ключевые метрики</h3>
