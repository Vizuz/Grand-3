          ...
          <div className="space-y-6">
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg  text-primary-900 mb-4">Последние заявки</h3>
              ...
              <div className="bg-white rounded-lg shadow-lg p-6">
                <h3 className="text-lg  text-primary-900 mb-4">Быстрые действия</h3>
                <div className="space-y-3">
                  <button 
            ...
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h3 className="text-lg  text-primary-900 mb-4">Аналитика в реальном времени</h3>
