        ...
        {content.map((item, idx) => (
          <section className={styles.section} key={idx}>
            ...
            <article className={styles.content}>
              ...
              <p>
                9-этажный кирпичный жилой комплекс комфорт-класса: 1
                коммерческий этаж + 8 жилых с просторными квартирами.
              </p>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  Фасады — декоративный керамический кирпич «flash» трёх
                  оттенков
                </li>
                <li>
                  Металлопластиковые окна, 5-камерный профиль, двухкамерный
                  стеклопакет (3 стекла)
                </li>
                <li>
                  Лоджии полностью остеклены, создавая светлые, уютные помещения
                </li>
              </ul>
              ...
              <ul className={styles.list}>
                <li>
                  Ограждённые детские площадки с современными игровыми
                  комплексами
                </li>
                <li>Спортивные площадки и тихие зоны отдыха с озеленением</li>
                <li>
                  Чётко разделённые пешеходные маршруты и парковки (гостевые +
                  жилые)
                </li>
              </ul>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  Свободный объём под мини-маркет, офис, медцентр, банкомат-зону
                  и т. д.
                </li>
              </ul>
              ...
              <ul className={styles.list}>
                <li>
                  Дизайнерские входные группы с моховыми панно и акцентной
                  подсветкой
                </li>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  Рядом детский сад, спорткомплекс, благоустроенная набережная
                  оз. Копа — всё в шаговой доступности
                </li>
              </ul>
            </article>
          </section>
