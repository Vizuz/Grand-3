...
export default function TourCard({
  ...
  return (
    ...
    >
      ...
      <div className="content-area p-4 sm:p-5 lg:p-7" data-tilt-transform-element>
        ...
        <div className="text-block font-serif-display" data-tilt-transform-element>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-2 flex items-center justify-center gap-2">
            <svg className="mountain-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <p className="text-sm sm:text-base lg:text-lg font-light">{location}</p>
        </div>
