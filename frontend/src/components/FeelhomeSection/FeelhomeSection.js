...
const defaultSubtitle = 'Качество Grand Komfort Stroy — ваша гарантия спокойствия.';
const defaultImage = 'https://storage.yandexcloud.net/vizuz/процесс стройки.webp';
    ...
    <section ref={ref} className={`${bg} py-16 px-4 sm:px-6 lg:px-8`}>      
      ...
      {paragraphs.length > 0 && (
        <div className={`max-w-5xl mx-auto grid md:grid-cols-2 gap-8 ${tBase} delay-300 ${visible ? fadeEnd : fadeStart}`}>          
          <p className="leading-relaxed text-gray-700 md:pr-6">{paragraphs[0]}</p>
