    ...
    <div className="bg-white rounded-lg p-6 shadow-lg">
      ...
      <div className="space-y-6">
        ...
        <div className="border-t pt-6">
          <h4 className=" text-primary-900 mb-4 flex items-center">
        ...
        {/* CTA */}
        <button className="w-full bg-accent hover:bg-accent-600 text-white px-4 py-3 rounded-lg  transition-colors">
